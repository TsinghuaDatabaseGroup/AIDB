...
**[Search-based]** OpenTuner: An Extensible Framework for Program Autotuning (PACT, 2014)

**[Search-based]** BestConfig: Tapping the Performance Potential of Systems via Automatic Configuration Tuning (SoCC, 2017)

#### BO-based

**[Gaussian Process]** Tuning Database Conﬁguration Parameters with iTuned. (VLDB, 2009)

**[Gaussian Process]** Automatic database management system tuning through large-scale machine learning. (SIGMOD, 2017)

**[Gaussian Process, Featurization]** Black or White? How to Develop an AutoTuner for Memory-based Analytics (SIGMOD, 2020)

**[Gaussian Process, Model Transferring]** ResTune: Resource Oriented Tuning Boosted by Meta-Learning for Cloud Databases (SIGMOD, 2021)

**[Contextual Gaussian Process]** CGPTuner: a Contextual Gaussian Process Bandit Approach for the Automatic Tuning of IT Configurations Under Varying Workload Conditions (VLDB, 2021)

**[Bounded Gaussian Process]** Towards Dynamic and Safe Configuration Tuning for Cloud Databases (SIGMOD, 2022)

**[Gaussian Process]** LlamaTune: Sample-Efficient DBMS Configuration Tuning (VLDB, 2022)
...
**[RL, Pre-trained model]** Watuning: A workload-aware tuning system with attention-based deep reinforcement learning. (JCST, 2021)
...
**[RL, Genetic algorithm]** HUNTER- An Online Cloud Database Hybrid Tuning System for Personalized Requirements (SIGMOD,2022 )
...
Facilitating Database Tuning with Hyper-Parameter Optimization- A Comprehensive Experimental Evaluation (VLDB, 2021)
